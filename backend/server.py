...
async def create_order(order_data: OrderCreate):
    ...
    # Envoyer notification aux administrateurs (with payment instructions for manual payments)
    try:
        admin_order_dict = order.model_dump()
        admin_order_dict["payment_gateway_instructions"] = payment_gateway_instructions
        admin_order_dict["payment_gateway_name"] = payment_gateway_name
